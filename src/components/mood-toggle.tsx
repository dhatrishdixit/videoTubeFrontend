    ...
    <>
      <label className="themeSwitcherThree relative inline-flex cursor-pointer select-none items-center">
        <input
          ...
          className="sr-only"
        />
        <span className="mr-[18px] text-sm font-medium text-black dark:text-white"></span>
        <div className="shadow-card flex h-[46px] w-[82px] items-center justify-center rounded-md bg-white dark:bg-[#09090b]">
          <span
