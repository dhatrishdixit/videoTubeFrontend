...
type btnTypes = {
    name:string,
    clickHandler:()=>void,
    variant:"outline" | "secondary" | "destructive" | "link" | "default" | "ghost" | null | undefined
} 
const arr:btnTypes[] = [
  {
    name:"Home",
...
export function SideBar() {
  return (
    ...
    {
       arr.map(curr=>(
        <Button variant={curr.variant} className="w-full mt-2  hover:bg-red-600  " onClick={curr.clickHandler}>
        {curr.name}
      </Button>
       ))
    }
